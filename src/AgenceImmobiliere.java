public class AgenceImmobiliere {
    public static void main(String[] args) throws Exception {
        ...
        appartement.ajouterPiece(new PieceQuadrilatere(chambre, "0", 4.0, 3.0));
        appartement.ajouterPiece(new PieceTriangulaire(cuisine, "0", 6.0, 2.3));
        appartement.ajouterPiece(new PieceCirculaire(salon, "0", 2.1));
        appartement.ajouterPiece(new PieceQuadrilatere(Wc, "0", 1.5, 2.0));
        appartement.ajouterPiece(new PieceQuadrilatere(salleDeBain, "0", 2.0, 2.0));
        appartement.ajouterPiece(new PieceQuadrilatere(Cave, "-1", 3.0, 3.0));
        ...
        maison.ajouterPiece(new PieceTriangulaire(chambre, "1", 3.8, 6.0));
        maison.ajouterPiece(new PieceQuadrilatere(chambre, "1", 5.8, 2.8));
        maison.ajouterPiece(new PieceQuadrilatere(cuisine, "0", 6.0, 3.5));
        maison.ajouterPiece(new PieceQuadrilatere(salon, "0", 6.9, 4.4));
        maison.ajouterPiece(new PieceQuadrilatere(Wc, "0", 1.5, 2.0));
        maison.ajouterPiece(new PieceQuadrilatere(Wc, "1", 2.1, 2.0));
        maison.ajouterPiece(new PieceTrapezoidale(salleDeBain, "0", 2.6, 3.2, 3.1));
        maison.ajouterPiece(new PieceQuadrilatere(salleDeBain, "1", 2.6, 3.0));
        maison.ajouterPiece(new PieceQuadrilatere(Cave, "-1", 3.0, 4.2));
        maison.ajouterPiece(new PieceParallelogramme(Garage, "0", 5.0, 5.8));
